...
func (fc *FileCreate) check() error {
	...
	if _, ok := fc.mutation.ContentType(); !ok {
		return &ValidationError{Name: "content_type", err: errors.New("ent: missing required field \"content_type\"")}
	}
	if _, ok := fc.mutation.StoreKey(); !ok {
		return &ValidationError{Name: "store_key", err: errors.New("ent: missing required field \"store_key\"")}
	}
	return nil
}
